...
public class AdapterLoaiBB extends RecyclerView.Adapter<AdapterLoaiBB.ClassLTViewHoder>{
    ...
    public AdapterLoaiBB(Activity aa, ArrayList<ClassLT> list) {
        this.aa = aa;
        this.list = list;
    ...
    public ClassLTViewHoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.loaibienbao, parent, false);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedPosition != RecyclerView.NO_POSITION) {
                    Intent intent = new Intent(aa, Bienbao.class);
