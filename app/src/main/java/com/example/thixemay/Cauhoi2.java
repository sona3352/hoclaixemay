...
public class Cauhoi2 implements Serializable {
    private int hinhanh;  // URL hình ảnh
    ...
    public Cauhoi2(int hinhanh, String cauhoi, String luaChonA, String luaChonB, String luaChonC, String luaChonD, String dapAnDung,String giaithich) {
